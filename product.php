...
$country = isset($_GET['country']) ? $db->real_escape_string($_GET['country']) : '';

// Build the query with filters
$query = "
    SELECT product.*, units.name as unit, category.name as category, sub_category.name as sub_category
    FROM product
...
if ($sub_category) {
    $query .= " AND sub_category.name LIKE '%$sub_category%'";
}

if ($country) {
    $query .= " AND product.country LIKE '%$country%'";
}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="afghani_sale_price" name="afghani_sale_price"
        ...
        function getInfo(id) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $("#edit-modal #toman_sale_price").val(res["toman<?php require_once "includes/conn.php";
